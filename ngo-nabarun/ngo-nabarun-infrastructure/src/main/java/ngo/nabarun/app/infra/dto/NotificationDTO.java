...
public class NotificationDTO {
	...
	public NotificationDTO(Map<String, Object> sourceMap){
		...
		//this.extLink=sourceMap.get("ext_link") == null ? null : sourceMap.get("ext_link").toString();
		...
		this.notificationDate=sourceMap.get("notification_date") == null ? null : CommonUtils.getFormattedDate(sourceMap.get("notification_date").toString(), dateFormat);
		this.itemClosureDate=sourceMap.get("close_date") == null ? null : CommonUtils.getFormattedDate(sourceMap.get("close_date").toString(), dateFormat);
		this.itemClosed=sourceMap.get("is_closed") == null ? false : Boolean.valueOf(sourceMap.get("is_closed").toString());
		this.itemClosedBy=sourceMap.get("close_by") == null ? null : UserDTO.class.cast(sourceMap.get("close_by"));
		this.readDate=sourceMap.get("read_date") == null ? null : CommonUtils.getFormattedDate(sourceMap.get("read_date").toString(), dateFormat);
	}
	...
	public Map<String,String> toMap(){
		...
		map.put("senderImage", source == null ? null:source.getImageUrl());
