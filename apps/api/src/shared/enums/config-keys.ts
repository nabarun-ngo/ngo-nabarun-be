export enum Configkey {
  ...
  // Rate limiting (requests per THROTTLE_*_TTL_MS window)
  THROTTLE_DEFAULT_LIMIT = "THROTTLE_DEFAULT_LIMIT",
  THROTTLE_DEFAULT_TTL_MS = "THROTTLE_DEFAULT_TTL_MS",
  THROTTLE_OPEN_LIMIT = "THROTTLE_OPEN_LIMIT",
  THROTTLE_OPEN_TTL_MS = "THROTTLE_OPEN_TTL_MS",
  THROTTLE_PROTECTED_LIMIT = "THROTTLE_PROTECTED_LIMIT",
  THROTTLE_PROTECTED_TTL_MS = "THROTTLE_PROTECTED_TTL_MS",
}
