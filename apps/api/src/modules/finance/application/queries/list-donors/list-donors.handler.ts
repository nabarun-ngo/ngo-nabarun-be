...
import { BaseFilter, IUserLookupPort, PagedResponse } from '@nabarun-ngo/nestjs-shared-core';
...
@Injectable()
export class ListDonorsHandler implements IQueryHandler<ListDonorsQuery, PagedResponse<DonorDto>> {
  constructor(
  ...
  async execute(query: ListDonorsQuery): Promise<PagedResponse<DonorDto>> {
