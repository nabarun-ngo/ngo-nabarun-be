...
import { ProjectPrismaRepository } from '../../shared/persistence/project/repositories/project.prisma-repository';
import { ActivityPrismaRepository } from '../../shared/persistence/project/repositories/activity.prisma-repository';
import { BeneficiaryPrismaRepository } from '../../shared/persistence/project/repositories/beneficiary.prisma-repository';
import { GoalPrismaRepository } from '../../shared/persistence/project/repositories/goal.prisma-repository';
import { TeamMemberPrismaRepository } from '../../shared/persistence/project/repositories/team-member.prisma-repository';
import { ProjectRiskPrismaRepository } from '../../shared/persistence/project/repositories/project-risk.prisma-repository';
import { MilestonePrismaRepository } from '../../shared/persistence/project/repositories/milestone.prisma-repository';
