...
export class GoalController {
  ...
  @Get() @RequirePermissions('read:goals')
  @ApiUuidParam('projectId', 'Identifier of the parent project')
  @ApiPaginationQuery()
  @ApiAutoResponse(GoalListResponseDto)
  list(@Param('projectId') projectId: string, @Query('pageIndex') pageIndex?: number, @Query('pageSize') pageSize?: number): Promise<GoalListResponseDto> {
