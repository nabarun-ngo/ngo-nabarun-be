...
import { ActivityScale } from '../../../project/domain/enums/activity.enum';
import { BeneficiaryStatus } from '../../../project/domain/enums/beneficiary.enum';
import { ProjectStatus } from '../../../project/domain/enums/project.enum';
import { ProjectFacade } from '../../../project/application/services/project.facade';
import { UserStatus } from '../../../user/domain/enums/user-status.enum';
import { UserFacade } from '../../../user/application/services/user.facade';
import { mapPublicSiteDynamicContent } from '../../application/mappers/public-site-dynamic-content.mapper';
import { IPublicSiteDynamicContentPort } from '../../domain/ports/public-site-dynamic-content.port';
